// Lecture Prisma du détail d'expérience (SERVEUR uniquement) + helpers de rendu.
// Séparé de experience-detail.ts (client-safe : types + eur/eurDecimal) pour ne
// pas embarquer le driver pg côté client.
