// Console admin Sociuly — accès Prisma, module SERVEUR uniquement.
// Séparé de `lib/admin/data.ts` (types/libellés purs) pour qu'un Client Component
// puisse importer un libellé sans embarquer le driver `pg` (Node-only).
