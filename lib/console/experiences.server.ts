// Lecture Prisma des expériences d'un club (SERVEUR uniquement).
// Séparé de experiences.ts (client-safe : types + libellés) pour ne pas embarquer
// le driver pg côté client.
