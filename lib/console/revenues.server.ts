// Accès Prisma aux revenus de la console club — module SERVEUR uniquement.
// Séparé de `lib/console/revenues.ts` (types/libellés purs) pour qu'un Client
// Component puisse importer un libellé sans embarquer le driver `pg` (Node-only).
// Cf. SPEC.md §4 — Booking / Invoice · §5 — commission 6 % / versement J+1.
