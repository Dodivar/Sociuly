...
export default function MarketplaceError({
  ...
  return (
    ...
    >
      ...
      <h2 className="sy-h1" style={{ marginBottom: 10 }}>Impossible de charger le marketplace</h2>
      <p className="sy-body" style={{ color: "var(--ink-2)", maxWidth: 420, marginBottom: 28 }}>
        Une erreur est survenue lors du chargement des prestations. Vérifiez votre connexion et réessayez.
      </p>
